...
ç§‘ç›®ã€‚ç§‘ç›®ã¯ç‹¬è‡ªã«è¿½åŠ ã§ãã‚‹ã¨ã—ã¦ã€ãƒ†ãƒŠãƒ³ãƒˆæ¯Žã«ç§‘ç›®ã‚’ç”¨æ„ã™ã‚‹ã€‚
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='ç§‘ç›®ã€‚ç§‘ç›®ã¯ç‹¬è‡ªã«è¿½åŠ ã§ãã‚‹ã¨ã—ã¦ã€ãƒ†ãƒŠãƒ³ãƒˆæ¯Žã«ç§‘ç›®ã‚’ç”¨æ„ã™ã‚‹ã€‚'
```
